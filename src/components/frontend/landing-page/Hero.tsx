  ...
  return (
    <section className="grid pc:grid-cols-[50%_50%] gap-6 lg:gap-12 pt-4 pb-12 pc:pt-8 relative w-full -mt-12 sm:-mt-0">
      ...
      <div className="flex flex-col justify-center items-start w-full">
        ...
        <div className="space-y-1 sm:space-y-6 w-full max-w-[650px]">
          
          {/* Top Badge (Pill 1) - Fading effect from peach/orange to transparent */}
          <span className="inline-block bg-gradient-to-r from-[#ffedd5] to-transparent text-yellow-700 text-xs sm:text-sm font-semibold pl-4 pr-8 py-[6px] rounded-full">
